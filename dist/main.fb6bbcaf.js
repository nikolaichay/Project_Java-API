...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/untill.js":[function(require,module,exports) {
"use strict";
...
var sign_up_link_id = 'sign_up_link';
var sign_up_btn_id = 'sign_up_btn';
var sign_in_form_id = 'sign_in_form';
var sign_in_btn_id = 'sign_in_btn';
var first_name = document.getElementById(first_name_id);

first_name.oninput = function (e) {
  return (0, _untill.setFormValue)(first_name_id, e.target.value);
};

var email = document.getElementById(email_id);

email.oninput = function (e) {
  return (0, _untill.setFormValue)(email_id, e.target.value, _untill.validateEmail);
};

var password = document.getElementById(password_id);

password.oninput = function (e) {
  (0, _untill.setFormValue)(password_id, e.target.value, _untill.validatePassword);

  if (!(0, _untill.getValidation)(password_id)) {
...
sign_in_btn.onclick = function (e) {
  e.preventDefault();
  (0, _untill.submitSignInForm)();
};
},{"./untill.js":"js/untill.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
